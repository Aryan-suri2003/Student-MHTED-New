...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  ...
  return (
    <aside className="w-full lg:w-[282px] bg-brand-900 p-4 lg:p-6 border-b lg:border-b-0 lg:border-r border-brand-800 flex flex-row lg:flex-col overflow-x-auto no-scrollbar gap-2 lg:gap-3.5 h-fit lg:h-full scroll-smooth flex-shrink-0">
